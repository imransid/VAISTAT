export interface IResult {
  ...
  devices: any[]; // You might want to define a more specific interface here if you have more information about the devices.
  lat_long: [number, number];
  createdAt: string;
  __v: number;
  last_payment_received_on: string;
  restrictPublicJobs: boolean;
  paysafeProfileId: string | null;
  linked_pharmacies: any[]; // You might want to define a more specific interface here if you have more information about the linked pharmacies.
}
...
export interface SignINApiResponse {
  ...
  result: {
    ...
    profile_img_status: string;
    pan_card: string;
    devices: any[]; // You may want to replace this with a specific type
    app_info: {
      app_version: string;
      device_name: string;
      device_version: string;
    ...
    dispatchCompanyId: null | number;
    registeredFrom: string;
    restrictPublicJobs: boolean;
    paysafeProfileId: null | number;
    _id: string;
    linked_pharmacies: any[]; // You may want to replace this with a specific type
    __v: number;
  };
}
